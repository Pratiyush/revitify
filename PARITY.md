...
> Reference: graphify 0.8.38 (PyPI == .track pin) run OFFLINE on a copy of llm-dev-kit; revitify run on the same copy.
...
| links | 1502 | 1794 |
| relation types | 6 | 7 |
| relations | imports_from 430, contains 378, calls 357, imports 301, re_exports 25, method 11 | contains 699, imports 428, calls 302, imports_from 300, re_exports 26, references 23, method 16 |
| communities | 49 | 66 |
| source files | 141 | 158 |
...
|---|---|---|---|
| node count ≥70% of reference | ❌ gap | 528 vs 900 (59%) | P2 multi-language + P4 why-nodes |
| link count ≥70% of reference | ✅ pass | 1502 vs 1794 (84%) | P2-P3 (calls/imports_from/re_exports) |
| relation types ≥70% of reference | ✅ pass | 6 vs 7 | P2-P3 |
| community count ≥70% of reference | ✅ pass | 49 vs 66 | P3 Leiden |
...
- revitify links carry `confidence` (same EXTRACTED/INFERRED/AMBIGUOUS vocabulary) since
  Phase 1b: EXTRACTED 715, INFERRED 783, AMBIGUOUS 4 — graphify also scores `confidence_score`/`weight` (Phase 3).
